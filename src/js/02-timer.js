...
flatpickr(input, 
  ...
  start.addEventListener('click', () => {
    ...
    const countdown = setInterval(() => {
      ...
      timer.querySelector('[data-days]').innerHTML = convertedTime.days.toString().padStart(2, "0");
      timer.querySelector('[data-hours]').innerHTML = convertedTime.hours.toString().padStart(2, "0");
      timer.querySelector('[data-minutes]').innerHTML = convertedTime.minutes.toString().padStart(2, "0");
      timer.querySelector('[data-seconds]').innerHTML = convertedTime.seconds.toString().padStart(2, "0");
